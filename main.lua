...
local function safeLoad()
    ...
    -- Контейнер экранной кнопки с возможностью закрытия
    ...
    local function runGlitchFling(targetChar)
        ...
        if hrp and targetChar and targetChar:FindFirstChild("HumanoidRootPart") then
            ...
            -- Новая агрессивная механика флинга (Обход хитбоксов Roblox 2026)
    ...
    KTitle.Size = UDim2.new(1, 0, 0, 35); KTitle.Text = "LEMONHUB V9.0 | Авторизация"; KTitle.TextColor3 = Color3.fromRGB(255,255,255)
